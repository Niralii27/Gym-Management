                            ...
                            <tbody>
                                ...
                                while(list($id, $Name, $Weight, $Goal, $Skill, $Duration, $Days, $Exercise) = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>
                                             <a href='editplan.php?id=$id' class='text-primary' title='Edit'  style='margin-right: 15px;'>
                                                    <i class='fa fa-edit fa-lg'></i>
                                            </a>

                                             <a href='plan.php?id=$id&action=delete' class='text-danger' style='margin-right: 15px;' title='Delete' onclick='return confirm(\"Are you sure you want to delete this contact?\")'>
                                                    <i class='fa fa-trash fa-lg'></i>
                                             </a>
                                                
                                            <a class='text-primary' href='#' onclick='showDropdown($id)'>  <i class='fa fa-plus fa-lg'></i></a>

                                ...
                                while (list($id, $name, $email, $number, $weight, $gender, $classes, $image, $created_at) = mysqli_fetch_array($result)) {
                                    echo "<tr>
                                            ...
                                            <td>$created_at</td>
                                             ...
                                             <td>
                                            <a href='editprofile.php?id=$id' class='text-primary' title='Edit'  style='margin-right: 15px;'>
                                                <i class='fa fa-edit fa-lg'></i>
                                            </a>
                                            <a href='profile.php?id=$id&action=delete' class='text-danger' title='Delete' onclick='return confirm(\"Are you sure you want to delete this contact?\")'>

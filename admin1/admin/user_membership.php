                ...
                <form action="" method="get" class="form-inline float-right">
                    <div class="input-group">
                        ...
                        <?php if (isset($_GET['search'])) { ?>
                            <a href="user_membership.php" class="btn btn-default">Clear Search</a>
                        <?php } ?>
                    </div>
                </form>
            </div>
                                ...
                                while (list($id, $name, $amount, $user_id, $membership_id, $date, $created_at) = mysqli_fetch_array($result)) {
                                    echo "<tr>
                                            ...
                                            <td>
                                                    ...
                                                    <a href='edituser_membership.php?id=$id' class='text-primary' title='Edit'  style='margin-right: 15px;'>
                                                        <i class='fa fa-edit fa-lg'></i>
                                                    </a>
                                                    <a href='user_membership.php?id=$id&action=delete' class='text-danger' title='Delete' onclick='return confirm(\"Are you sure you want to delete this contact?\")'>

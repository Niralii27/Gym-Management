    ...
    <?php 
       ...
       ";
        ...
        echo"<td>
         ...
         <a href='edituser_plan.php?id=$id' class='text-primary' title='Edit'  style='margin-right: 15px;'>
              <i class='fa fa-edit fa-lg'></i>
          </a>
          <a href='user_plan.php?id=$id&action=delete' class='text-danger' title='Delete' onclick='return confirm(\"Are you sure you want to delete this contact?\")'>

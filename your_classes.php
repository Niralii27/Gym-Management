...
.plan-container {
    margin-left: 470px; /* Adjust the value as needed */
}
...
<div class="form-container plan-container">
    <form id="transparent-form1">
...
<br>
        ...
        <div class="grid-row">
                ...
                <input type="text" id="name" name="name" placeholder="CLASS_NAME" style="font-size: 17px" value="<?php echo $userData['classes']; ?>">
            </div>
            ...
            <div class="grid-item">
        <button type="button"><a href="classes.php">Add New Class</a></button>
</div>
   <!-- <div class="grid-item">
